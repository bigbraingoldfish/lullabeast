...
- [ ] `UI-8` | LOW | Show a floating hover detail card to the right of the sidebar on project row hover (320 ms delay, mouse-leave dismiss)
...
- [ ] `UI-9` | LOW | Remove the inline readiness score display from the chat panel header bar
