...
- **File read** — Read planner output, existing source code, test files, and directory structure. Use targeted reads (specific line ranges, `grep` for function names) rather than reading entire large files, which consume context quickly.
