...
H26_ACTIVITY = "Key orchestrator + gate + webhook events on Activity tab (full diagnostics in the Pipeline log); escalation-only on Escalation tab; live orchestrator log on Pipeline log tab."
